...
QT_MOC_LITERAL(3, 17, 8), // "groupFon"
QT_MOC_LITERAL(4, 26, 8), // "QAction*"
QT_MOC_LITERAL(5, 35, 10), // "groupBoard"
QT_MOC_LITERAL(6, 46, 4), // "font"
QT_MOC_LITERAL(7, 51, 13), // "colorTextEdit"
QT_MOC_LITERAL(8, 65, 5) // "about"

    },
    "MenuBar\0newGame\0\0groupFon\0QAction*\0"
    "groupBoard\0font\0colorTextEdit\0about"
};
...
void MenuBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->groupFon((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 2: _t->groupBoard((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::newGame)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::groupFon)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MenuBar::*)(QAction * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::groupBoard)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MenuBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::font)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (MenuBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::colorTextEdit)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (MenuBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::about)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 1
void MenuBar::groupFon(QAction * _t1)
{
...
// SIGNAL 2
void MenuBar::groupBoard(QAction * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
